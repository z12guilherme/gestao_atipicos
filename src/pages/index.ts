...
const studentSchema = z.object({
  ...
  school_year: z.string().min(1, "Ano escolar é obrigatório"),
  status: z.enum(['ativo', 'inativo', 'avaliando'], {
    errorMap: () => ({ message: "Status deve ser 'ativo', 'inativo' ou 'avaliando'" })
  }),
  // Adicione outros campos que você queira importar
